...
const Footer = () => {
    return (
        <div className=' relative'>
            <footer className="footer footer-center p-10 bg-base-200 text-base-content rounded sticky bottom-0">
                ...
                <aside>
                    <p>Copyright © 2024 - All right reserved by Love Lens Ltd</p>
                </aside>
            </footer>
        </div>
    );
